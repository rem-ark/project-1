...
from roblox import Utils as Utils
from typing import Union
def GetID(usernames: list[str]) -> Union[int, str]:
    """
...
def GetHeadshot(UserID: int, Width: int = 420, Height: int = 420, circular: bool = False) -> str:
    """
    ...
    response = requests.get(
        f"https://thumbnails.roblox.com/v1/users/avatar-headshot?userIds={UserID}&size={Width}x{Height}&format=png&isCircular={circular}")
